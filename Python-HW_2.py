...
# переменные-счетчики четных (even) и нечетных (odd) цифр
# return ["even", "odd"][num % 2]
item_1 = (random.randrange(0, 99, 1))
if (item_1 % 2 == 1):
    print(item_1)
else:
    item_1 += 1
...
item_2 = (random.randrange(0, 99, 1))
if (item_2 % 2 == 0):
    print(item_2)
else:
    item_2 += 1
...
# result_m_floor = round(result_division, 0)
...
# Здесь далее реализация через арифметические действия с присваиванием.
#
#  33. Создать переменную item_3 и присвоить ей целое число
item_3 = (random.randrange(0, 99, 1))
print(item_3)
...
# передача аргумента исключения except
try:
    # b_item_t = True
    # b_item_f = False
    print(b_item_t / b_item_f)
except ZeroDivisionError:
    print("На 0 делить нельзя!")
#  57. Вывести b_item_relult_division в консоль. (Получить ошибку)
# print(b_item_relult_division)
# line 134, in <module> b_item_relult_division = b_item_t / b_item_f  ZeroDivisionError: division by zero
